...
from scipy.integrate import solve_ivp  # import the ODE solver used in simulate()
# endregion
...
def odeSystem(t,X, *args):
    ...
    i1dot=(vt - R * i2) / L #inductor equation using node voltage across the resistor/capacitor branch
    i2dot=(i1 - i2) / (R * C) #capacitor current relation combined with Ohm's law for the resistor
    return [i1dot, i2dot]
